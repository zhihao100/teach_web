...
<head>
    <meta charset="UTF-8">
    <title>在线答题</title>
    <link rel="stylesheet" type="text/css" href="CSS/onlineanswer.css">
</head>
<body>
<div class="header">
    <!--logo start-->
    ...
    <div class="bar">
        <ul>
            ...
            <li class="active"><a href="onlineanswer.php" >在线答题</a></li>
...
<div class="sidebar">
    <ul>
        <li class="box">
            <a class="menu-box">我的作业</a>
            <ul class="menu-list" style="display:none;">
                <li><a href="homework_done_list.php" target="mainframe">已交作业</a></li>
                <li><a href="homework_undo_list.php" target="mainframe">未交作业</a></li>
            </ul>
        </li>
