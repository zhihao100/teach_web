...
<body>
<div class="bar"><h3><a href="#">首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;添加管理员</h3></div>
<div class="wrap">
<form action="doActionAdmin.php?act=addAdmin" method="post">
	<table cellpadding="0px"  cellspacing="0px">
    	<tr>
    		<td>账户名:<input type="text" placeholder="请输入账号" name="username" id="username"/></td>
        </tr>
        <tr>
        ...
        <tr>
    		<td class="td1">专业:<input type="text" placeholder="请输入专业" name="profession" id="profession" /></td>
        </tr>
    </table>
